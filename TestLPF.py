import numpy as np					            # Numpyモジュールを読み込み，npと名付ける
import numpy.fft as fft                         # Numpyのfftライブラリを読み込み，fftと名付ける
import matplotlib.pyplot as plt		            # matplotlibのpyplotライブラリを読み込み，pltと名付ける
